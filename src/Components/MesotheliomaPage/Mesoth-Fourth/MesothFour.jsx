...
const MesothFourth = () => {
  return (
    <div className="flex flex-col items-center bg-[#f7ede3] ">
      ...
      <i className="w-[582px] relative text-[64px] underline inline-block font-[Georgia] text-[#4b2c5e] text-center">Common Symptoms</i>
      ...
      <i style={{width: "359px", position: "relative", fontSize: "64px", textDecoration: "underline", display: "inline-block", fontFamily: "Georgia", color: "#4b2c5e", textAlign: "center",}}>Risk Factors</i>
      
      <div className="grid grid-cols-2 gap-16 mt-10 place-items-center max-w-4xl mx-auto p-0px">
        <div className="p-6 rounded-lg flex flex-col items-center w-[120%]">
