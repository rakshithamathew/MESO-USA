...
const MesothFourth = () => {
    return (
        <div className="flex flex-col items-center bg-[#f7ede3] ">
            ...
            <i className="text-[#4B2C5E] text-center font-georgia italic text-4xl md:text-5xl lg:text-6xl font-normal leading-normal underline decoration-solid decoration-[rgba(75,44,94,0.55)] decoration-[3%] underline-offset-[14%] underline-from-font [text-decoration-skip-ink:none] [font-feature-settings:'dlig'on] decoration-opacity-70">Common Symptoms</i>

            <div className="w-full max-w-6xl mx-auto flex flex-row items-center justify-center flex-wrap content-center gap-y-3 gap-x-4 text-base md:text-xl lg:text-2xl p-4">
                <div className="rounded-full bg-white/40 border border-[#4b2c5e]/70 overflow-hidden flex flex-row items-center justify-center px-4 py-2 md:px-6 md:py-4">
                    <div className="relative">Persistent Chest Pain</div>
                </div>
                <div className="rounded-full bg-white/40 border border-[#4b2c5e]/70 overflow-hidden flex flex-row items-center justify-center px-4 py-2 md:px-6 md:py-4">
                    <div className="relative">Chronic Cough</div>
            ...
            <div className="w-4/5 mx-auto relative border-t-2 md:border-t-3 border-[rgba(75,44,94,0.55)] box-border h-px my-8 md:my-12" />

            {/* Risk Factors Section */}
            <i className="text-[#4B2C5E] text-center font-georgia italic text-4xl md:text-5xl lg:text-6xl font-normal leading-normal underline decoration-solid decoration-[rgba(75,44,94,0.55)] decoration-[3%] underline-offset-[14%] underline-from-font [text-decoration-skip-ink:none] [font-feature-settings:'dlig'on] decoration-opacity-70">Risk Factors</i>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 md:gap-x-8 lg:gap-x-16 gap-y-6 mt-6 md:mt-10 place-items-center max-w-4xl mx-auto px-4 mb-10">
                <div className="p-3 md:p-6 rounded-lg flex flex-col items-center w-full md:w-full lg:w-[120%] pb-0">
                    <img src={image1} alt="Risk Factor 1" className="w-full h-32 md:h-48 object-cover rounded-lg mb-4" />
                </div>
                <div className="p-3 md:p-6 rounded-lg flex flex-col items-center w-full md:w-full lg:w-[120%] pb-0">
                    <img src={image2} alt="Risk Factor 2" className="w-full h-32 md:h-48 object-cover rounded-lg mb-4" />
                </div>
                <div className="p-3 md:p-6 rounded-lg flex flex-col items-center w-full md:w-full lg:w-[120%] pt-0">
                    <img src={image3} alt="Risk Factor 3" className="w-full h-32 md:h-48 object-cover rounded-lg mb-4" />
                </div>
                <div className="p-3 md:p-6 rounded-lg flex flex-col items-center w-full md:w-full lg:w-[120%] pt-0">
                    <img src={image4} alt="Risk Factor 4" className="w-full h-32 md:h-48 object-cover rounded-lg mb-4" />
                </div>
            </div>
        </div>
    );
