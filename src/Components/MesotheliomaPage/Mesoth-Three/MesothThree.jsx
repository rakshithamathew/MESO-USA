        ...
        <div className="w-full px-8 lg:px-16 py-12 relative">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="w-full max-w-[1014px] flex flex-wrap justify-center gap-3 mb-16 lg:mb-24 xl:mb-32">
              <div className="flex px-6 py-2 justify-center items-center gap-[10px] rounded-[60px] border border-[rgba(75,44,94,0.70)] bg-white bg-opacity-40 text-[#4B2C5E] [font-feature-settings:'dlig'on] font-helvetica text-xl lg:text-2xl font-normal leading-normal">
                Asbestos Exposure
              </div>
              <div className="flex px-6 py-2 justify-center items-center gap-[10px] rounded-[60px] border border-[rgba(75,44,94,0.70)] bg-white bg-opacity-40 text-[#4B2C5E] [font-feature-settings:'dlig'on] font-helvetica text-xl lg:text-2xl font-normal leading-normal">
                Environmental Exposure from Air or Soil
