                ...
                <div className="relative w-full md:w-[1014px] h-auto md:h-[520px] mx-auto">
                    <div className="relative w-full md:w-[1135px] h-auto md:h-[200px] flex flex-col md:block items-center">
                        <img 
                            ...
                            src={Img1} 
                        />
                        <i className="relative text-center md:text-left mt-6 md:mt-0 md:top-[110px] text-[48px] md:text-[96px] md:left-[100px]">
                            <span className="font-['Georgia'] italic">{`Let's Act Together!`}</span>
                        </i>
                    </div>
                    <div className="relative w-full md:w-[796px] h-auto md:h-[200px] md:left-[300px] md:top-[100px] mt-8 md:mt-0 font-['Helvetica'] text-[18px] md:text-[24px] text-[#4b2c5e] text-center md:text-left">
