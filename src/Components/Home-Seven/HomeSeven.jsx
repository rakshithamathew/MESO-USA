...
const HomeSeven = () => {
    ...
    const faqItems = [
        ...
        {
            id: 22,
            question: 'How soon will I receive compensation after a successful claim?Court case compensation varies by jurisdiction but may take up to a year, while asbestos trust claims can be paid out within three months.',
            answer: '',
            category: 'fightForMeso',
            expanded: true
        }
